...
✉️ jgiguere@climatecentral.org



## Brief description of the indicator
This indicator measures attributes heatwave days to anthropogenic climate change by estimating temperatures in a counterfactual climate without human-caused forcing. The difference in heatwave days between observed and counterfactual datasets gives the number attributable to climate change.
