...
Indicator 1.1.3 provides estimates of heat-related labour capacity loss, measured as **work hours lost (WHL)**, at country level across four employment sectors:
...
For the **services sector**, earnings information was drawn from categories including:
...
For **manufacturing, agriculture and construction**, earnings information was drawn from relevant economic activity or occupation classifications, including:
...
The indicators, classifications and currencies were applied in a predefined order of preference to fill as many country-sector-year observations as possible.

## Selection of earnings observations
...
Monthly earnings were converted to hourly earnings using an assumed working schedule of:

- **40 hours per week**
- **4.33 weeks per month**
- **173.2 working hours per month**
...
Despite using multiple ILOSTAT indicators and classifications, approximately two thirds of the required earnings observations remained missing.
...
1. Where data were available for the same country and sector before and after the missing year, **linear interpolation** was used.
2. If no later observation was available, the nearest available earlier value was used.
3. If no earlier observation was available, the nearest available later value was used.
4. If no earnings data were available for a particular sector and country, data were taken from the same sector in a comparable country.

Comparable countries were selected primarily according to:

- Human Development Index
- World Bank Income Group
- GDP per capita
- geographic or social region
- population size
...
The resulting dataset provides estimates of hourly earnings for all four sectors between **1990 and 2025**.

Hourly earnings were multiplied by the corresponding **work hours lost** values from Indicator 1.1.3 for each country, sector and year.

For agriculture and construction, the work hours lost estimates assume that work takes place in the sun.
...
Total potential earnings lost were also expressed as a percentage of each country's GDP.

GDP data in nominal US dollars were obtained primarily from the **IMF World Economic Outlook database** and converted to constant 2025 US dollars using the GDP deflator.

Where IMF data were unavailable, additional GDP estimates were obtained from the **World Bank**.

Some remaining gaps in GDP data mean that estimates are not available for every country and year.

Results are also aggregated and presented by:
...
- **Work hours lost:** Indicator 1.1.3
- **Earnings by country and sector:** ILOSTAT Statistics on Wages, International Labour Organization
...
ILOSTAT does not provide complete coverage of all countries, years and sectors required for this indicator. Gap filling was therefore necessary, and estimates based on substituted or interpolated values are subject to additional uncertainty.

The analysis also depends on the reliability of the underlying ILOSTAT data, which may contain uncertainties arising from data collection, reporting and processing.

Several combinations of ILOSTAT indicators and activity classifications were required to maximise coverage. This may introduce inconsistencies because classifications and reporting methods can vary between datasets.
